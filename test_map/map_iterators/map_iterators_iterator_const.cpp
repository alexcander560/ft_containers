...
int	test_oper(int size, string test)
{
	...
	std::map<int, string>::const_iterator it_1_orig;
	std::map<int, string>::const_iterator it_2_orig;
	std::pair<int, string> pair_orig;

	ft::map<int, string> my;
	ft::map<int, string>::const_iterator it_1_my;
	ft::map<int, string>::const_iterator it_2_my;
	...
	//===========================ORIG==============================
	time_orig = clock();
	orig_const.begin() == orig_const.end() ? temp_orig += "NO" : temp_orig += "YES";
	orig_const.begin() != orig_const.end() ? temp_orig += "NO" : temp_orig += "YES";
	...
	//============================MY===============================
	time_my = clock();
	my_const.begin() == my_const.end() ? temp_my += "NO" : temp_my += "YES";
	my_const.begin() != my_const.end() ? temp_my += "NO" : temp_my += "YES";
