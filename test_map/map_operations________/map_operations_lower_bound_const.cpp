...
int	test_1()
{
	...
	//===========================ORIG==============================
	time_orig = clock();
	temp_orig += orig_const.lower_bound(21)->second;
	temp_orig += orig_const.lower_bound(42)->second;
	orig_it = --orig_const.lower_bound(100);
	temp_orig += orig_it->second;

	time_orig = clock() - time_orig;
	//============================MY===============================
	time_my = clock();
	temp_my += my_const.lower_bound(21)->second;
	temp_my += my_const.lower_bound(42)->second;
	my_it = --my_const.lower_bound(100);
...
int	test_2()
{
	...
	temp_orig += orig_const.lower_bound(-420)->second;

	for (int i = 0; i < SIZE_200; i++)
		temp_orig += orig_const.lower_bound(i)->second;

	orig_it = --orig_const.lower_bound(420);
	temp_orig += orig_it->second;
	...
	temp_my += my_const.lower_bound(-420)->second;

	for (int i = 0; i < SIZE_200; i++)
		temp_my += my_const.lower_bound(i)->second;

	my_it = --my_const.lower_bound(420);
	temp_my += my_it->second;
...
int	test_3()
{
	...
	temp_orig += orig_const.lower_bound(-42000)->second;

	for (int i = 0; i < SIZE_20K; i++)
		temp_orig += orig_const.lower_bound(i)->second;

	orig_it = --orig_const.lower_bound(42000);
	temp_orig += orig_it->second;
	...
	temp_my += my_const.lower_bound(-42000)->second;

	for (int i = 0; i < SIZE_20K; i++)
		temp_my += my_const.lower_bound(i)->second;

	my_it = --my_const.lower_bound(42000);
	temp_my += my_it->second;
...
int	test_4()
{
	...
	temp_orig += orig_const.lower_bound(-4200000)->second;

	for (int i = 0; i < SIZE_2M; i++)
		temp_orig += orig_const.lower_bound(i)->second;

	orig_it = --orig_const.lower_bound(4200000);
	temp_orig += orig_it->second;
	...
	temp_my += my_const.lower_bound(-4200000)->second;

	for (int i = 0; i < SIZE_2M; i++)
		temp_my += my_const.lower_bound(i)->second;

	my_it = --my_const.lower_bound(4200000);
	temp_my += my_it->second;
