...
int	main ()
{
	...
	orig_1.erase(orig_1.begin(), orig_1.begin());
	temp_orig += vektor_base_test(&orig_1);
	...
	my_1.erase(my_1.begin(), my_1.begin());
	temp_my += vektor_base_test(&my_1);
	//temp_my += " ";
	...
	//действия c оригиналом
	temp_orig += vektor_base_test(&orig_1);
	orig_1.erase(orig_1.begin(), orig_1.end());
	temp_orig += vektor_base_test(&orig_1);
	time_orig = clock() - time_orig;
	...
	//действия c собственной копией
	temp_my += vektor_base_test(&my_1);
	my_1.erase(my_1.begin(), my_1.end());
	temp_my += vektor_base_test(&my_1);
	//temp_my += " ";
	time_my = clock() - time_my;
	...
	orig_2.erase(orig_2.begin(), orig_2.begin());
	temp_orig += vektor_base_test(&orig_2);
	time_orig = clock() - time_orig;
	...
	my_2.erase(my_2.begin(), my_2.begin());
	temp_my += vektor_base_test(&my_2);
	//temp_my += " ";
	time_my = clock() - time_my;
	...
	//действия c оригиналом
	temp_orig += vektor_base_test(&orig_2);
	orig_2.erase(orig_2.begin(), orig_2.end());
	temp_orig += vektor_base_test(&orig_2);
	time_orig = clock() - time_orig;
	...
	//действия c собственной копией
	temp_my += vektor_base_test(&my_2);
	my_2.erase(my_2.begin(), my_2.end());
	temp_my += vektor_base_test(&my_2);
	//temp_my += " ";
	time_my = clock() - time_my;
